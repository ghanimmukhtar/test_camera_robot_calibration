...
int main(int argc, char **argv)
{
    ...
    if(result){
    ROS_INFO_STREAM("Quaternion angles are: " << my_calibrator->get_global_parameters().get_transformation_quaternion());
    ROS_WARN("*************************************");
    ...
    ROS_INFO_STREAM("Transformation matrix is: " << trans_matrix(0, 0) << ", " << trans_matrix(0, 1) << ", " << trans_matrix(0, 2) << ", " << trans_matrix(0, 3) << ", " <<
